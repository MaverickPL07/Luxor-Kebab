...
const Question = ({question}) => {
    ...
    return (
        <>
            <div className={`border-[1px] border-orangelight p-[3vh] my-[2vh] transition-all rounded-[1vh] w-[35vw] ${visible ? "h-fit" : ""}`} style={{boxShadow: `${visible ? "0 0 10px rgba(255, 168, 0, .8)" : ""}`, backgroundImage: "linear-gradient(45deg, rgba(153, 101, 0, .05), rgba(255, 168, 0, .5) 150%)"}}>
